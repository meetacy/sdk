...
__attribute__((swift_name("MeetacyRequestsEngine")))
@protocol SharedMeetacyRequestsEngine
@required
...
*/
- (void)executeRequest:(id<SharedMeetacyRequest>)request completionHandler:(void (^)(id _Nullable_result, NSError * _Nullable))completionHandler __attribute__((swift_name("execute(request:completionHandler:)")));
- (id)getFileUrlId:(id)id __attribute__((swift_name("getFileUrl(id:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("KtorMeetacyEngine")))
@interface SharedKtorMeetacyEngine : SharedBase <SharedMeetacyRequestsEngine>
- (instancetype)initWithBaseUrl:(id)baseUrl httpClient:(SharedKtor_client_coreHttpClient *)httpClient json:(SharedKotlinx_serialization_jsonJson *)json __attribute__((swift_name("init(baseUrl:httpClient:json:)"))) __attribute__((objc_designated_initializer));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("AuthorizedMeetacyApi")))
@interface SharedAuthorizedMeetacyApi : SharedBase
- (instancetype)initWithToken:(id)token base:(SharedMeetacyApi *)base __attribute__((swift_name("init(token:base:)"))) __attribute__((objc_designated_initializer));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)getMeWithCompletionHandler:(void (^)(SharedAuthorizedSelfUserRepository * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getMe(completionHandler:)")));
@property (readonly) SharedAuthorizedAuthApi *auth __attribute__((swift_name("auth")));
@property (readonly) SharedMeetacyApi *base __attribute__((swift_name("base")));
@property (readonly) SharedAuthorizedFilesApi *files __attribute__((swift_name("files")));
@property (readonly) SharedAuthorizedFriendsApi *friends __attribute__((swift_name("friends")));
@property (readonly) SharedAuthorizedMeetingsApi *meetings __attribute__((swift_name("meetings")));
@property (readonly) id token __attribute__((swift_name("token")));
@property (readonly) SharedAuthorizedUsersApi *users __attribute__((swift_name("users")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("MeetacyApi")))
@interface SharedMeetacyApi : SharedBase
- (instancetype)initWithEngine:(id<SharedMeetacyRequestsEngine>)engine __attribute__((swift_name("init(engine:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedMeetacyApiCompanion *companion __attribute__((swift_name("companion")));
- (SharedAuthorizedMeetacyApi *)authorizedToken:(id)token __attribute__((swift_name("authorized(token:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)getMeToken:(id)token completionHandler:(void (^)(SharedTypesSelfUser * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getMe(token:completionHandler:)")));
@property (readonly) SharedAuthApi *auth __attribute__((swift_name("auth")));
@property (readonly) id<SharedMeetacyRequestsEngine> engine __attribute__((swift_name("engine")));
@property (readonly) SharedFilesApi *files __attribute__((swift_name("files")));
@property (readonly) SharedFriendsApi *friends __attribute__((swift_name("friends")));
@property (readonly) SharedMeetingsApi *meetings __attribute__((swift_name("meetings")));
@property (readonly) SharedUsersApi *users __attribute__((swift_name("users")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("MeetacyApi.Companion")))
@interface SharedMeetacyApiCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedMeetacyApiCompanion *shared __attribute__((swift_name("shared")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("AuthApi")))
@interface SharedAuthApi : SharedBase
- (instancetype)initWithApi:(SharedMeetacyApi *)api __attribute__((swift_name("init(api:)"))) __attribute__((objc_designated_initializer));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)generateNickname:(NSString *)nickname completionHandler:(void (^)(id _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("generate(nickname:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)generateAuthorizedApiNickname:(NSString *)nickname completionHandler:(void (^)(SharedAuthorizedMeetacyApi * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("generateAuthorizedApi(nickname:completionHandler:)")));
@property (readonly) SharedEmailApi *email __attribute__((swift_name("email")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("AuthorizedAuthApi")))
@interface SharedAuthorizedAuthApi : SharedBase
- (instancetype)initWithApi:(SharedAuthorizedMeetacyApi *)api __attribute__((swift_name("init(api:)"))) __attribute__((objc_designated_initializer));
@property (readonly) SharedAuthApi *base __attribute__((swift_name("base")));
@property (readonly) SharedAuthorizedEmailApi *email __attribute__((swift_name("email")));
@property (readonly) id token __attribute__((swift_name("token")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("AuthorizedEmailApi")))
@interface SharedAuthorizedEmailApi : SharedBase
- (instancetype)initWithApi:(SharedAuthorizedMeetacyApi *)api __attribute__((swift_name("init(api:)"))) __attribute__((objc_designated_initializer));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)linkEmail:(id)email completionHandler:(void (^)(SharedLinkEmailResult * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("link(email:completionHandler:)")));
@property (readonly) SharedEmailApi *base __attribute__((swift_name("base")));
@property (readonly) id token __attribute__((swift_name("token")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("EmailApi")))
@interface SharedEmailApi : SharedBase
- (instancetype)initWithApi:(SharedMeetacyApi *)api __attribute__((swift_name("init(api:)"))) __attribute__((objc_designated_initializer));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)confirmEmail:(id)email confirmHash:(id)confirmHash completionHandler:(void (^)(id<SharedTypesConfirmEmailStatus> _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("confirm(email:confirmHash:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)linkToken:(id)token email:(id)email completionHandler:(void (^)(SharedLinkEmailResult * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("link(token:email:completionHandler:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("LinkEmailResult")))
@interface SharedLinkEmailResult : SharedBase
- (instancetype)initWithEmailApi:(SharedEmailApi *)emailApi email:(id)email __attribute__((swift_name("init(emailApi:email:)"))) __attribute__((objc_designated_initializer));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)confirmConfirmHash:(id)confirmHash completionHandler:(void (^)(id<SharedTypesConfirmEmailStatus> _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("confirm(confirmHash:completionHandler:)")));
@end
...
__attribute__((swift_name("MeetacyException")))
@interface SharedMeetacyException : SharedKotlinRuntimeException
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("MeetacyConnectionException")))
@interface SharedMeetacyConnectionException : SharedMeetacyException
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("MeetacyInternalException")))
@interface SharedMeetacyInternalException : SharedMeetacyException
- (instancetype)initWithMessage:(NSString *)message cause:(SharedKotlinThrowable * _Nullable)cause __attribute__((swift_name("init(message:cause:)"))) __attribute__((objc_designated_initializer));
@end

__attribute__((swift_name("MeetacyResponseException")))
@interface SharedMeetacyResponseException : SharedMeetacyException
- (instancetype)initWithCode:(int32_t)code message:(NSString *)message cause:(SharedKotlinThrowable * _Nullable)cause __attribute__((swift_name("init(code:message:cause:)"))) __attribute__((objc_designated_initializer));
@property (readonly) int32_t code __attribute__((swift_name("code")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("MeetacyUnauthorizedException")))
@interface SharedMeetacyUnauthorizedException : SharedMeetacyResponseException
- (instancetype)initWithMessage:(NSString *)message cause:(SharedKotlinThrowable * _Nullable)cause __attribute__((swift_name("init(message:cause:)"))) __attribute__((objc_designated_initializer));
- (instancetype)initWithCode:(int32_t)code message:(NSString *)message cause:(SharedKotlinThrowable * _Nullable)cause __attribute__((swift_name("init(code:message:cause:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
@property (class, readonly, getter=companion) SharedMeetacyUnauthorizedExceptionCompanion *companion __attribute__((swift_name("companion")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("MeetacyUnauthorizedException.Companion")))
@interface SharedMeetacyUnauthorizedExceptionCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedMeetacyUnauthorizedExceptionCompanion *shared __attribute__((swift_name("shared")));
@property (readonly) int32_t CODE __attribute__((swift_name("CODE")));
@end

__attribute__((swift_name("AuthorizedUserRepository")))
@protocol SharedAuthorizedUserRepository
@required
@property (readonly) id<SharedUserRepository> base __attribute__((swift_name("base")));
@property (readonly) id<SharedTypesUser> data __attribute__((swift_name("data")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("AuthorizedRegularUserRepository")))
@interface SharedAuthorizedRegularUserRepository : SharedBase <SharedAuthorizedUserRepository>
- (instancetype)initWithData:(SharedTypesRegularUser *)data api:(SharedAuthorizedMeetacyApi *)api __attribute__((swift_name("init(data:api:)"))) __attribute__((objc_designated_initializer));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)addFriendWithCompletionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("addFriend(completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)deleteFriendWithCompletionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("deleteFriend(completionHandler:)")));
@property (readonly) SharedFileRepository * _Nullable avatar __attribute__((swift_name("avatar")));
@property (readonly) SharedRegularUserRepository *base __attribute__((swift_name("base")));
@property (readonly) SharedTypesRegularUser *data __attribute__((swift_name("data")));
@property (readonly) id id __attribute__((swift_name("id")));
@property (readonly) NSString *nickname __attribute__((swift_name("nickname")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("AuthorizedSelfUserRepository")))
@interface SharedAuthorizedSelfUserRepository : SharedBase <SharedAuthorizedUserRepository>
- (instancetype)initWithData:(SharedTypesSelfUser *)data api:(SharedAuthorizedMeetacyApi *)api __attribute__((swift_name("init(data:api:)"))) __attribute__((objc_designated_initializer));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)editedNickname:(id<SharedTypesOptional>)nickname avatarId:(id<SharedTypesOptional>)avatarId completionHandler:(void (^)(SharedAuthorizedSelfUserRepository * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("edited(nickname:avatarId:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)editedNickname:(NSString *)nickname avatarId:(id _Nullable)avatarId completionHandler_:(void (^)(SharedAuthorizedSelfUserRepository * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("edited(nickname:avatarId:completionHandler_:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)updatedWithCompletionHandler:(void (^)(SharedAuthorizedSelfUserRepository * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("updated(completionHandler:)")));
@property (readonly) SharedAuthorizedMeetacyApi *api __attribute__((swift_name("api")));
@property (readonly) SharedAuthorizedAuthApi *auth __attribute__((swift_name("auth")));
@property (readonly) SharedFileRepository * _Nullable avatar __attribute__((swift_name("avatar")));
@property (readonly) SharedSelfUserRepository *base __attribute__((swift_name("base")));
@property (readonly) SharedTypesSelfUser *data __attribute__((swift_name("data")));
@property (readonly) id _Nullable email __attribute__((swift_name("email")));
@property (readonly) BOOL emailVerified __attribute__((swift_name("emailVerified")));
@property (readonly) SharedAuthorizedFilesApi *files __attribute__((swift_name("files")));
@property (readonly) SharedAuthorizedFriendsApi *friends __attribute__((swift_name("friends")));
@property (readonly) id id __attribute__((swift_name("id")));
@property (readonly) SharedAuthorizedMeetingsApi *meetings __attribute__((swift_name("meetings")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("AuthorizedUserRepositoryCompanion")))
@interface SharedAuthorizedUserRepositoryCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedAuthorizedUserRepositoryCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedAuthorizedUserRepository>)ofData:(id<SharedTypesUser>)data api:(SharedAuthorizedMeetacyApi *)api __attribute__((swift_name("of(data:api:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("AuthorizedUsersApi")))
@interface SharedAuthorizedUsersApi : SharedBase
- (instancetype)initWithApi:(SharedAuthorizedMeetacyApi *)api __attribute__((swift_name("init(api:)"))) __attribute__((objc_designated_initializer));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)editNickname:(id<SharedTypesOptional>)nickname avatarId:(id<SharedTypesOptional>)avatarId completionHandler:(void (^)(SharedAuthorizedSelfUserRepository * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("edit(nickname:avatarId:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)editNickname:(NSString *)nickname avatarId:(id _Nullable)avatarId completionHandler_:(void (^)(SharedAuthorizedSelfUserRepository * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("edit(nickname:avatarId:completionHandler_:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)getUserId:(id)userId completionHandler:(void (^)(id<SharedTypesUser> _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("get(userId:completionHandler:)")));
@property (readonly) SharedUsersApi *base __attribute__((swift_name("base")));
@property (readonly) id token __attribute__((swift_name("token")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("RegularUserRepository")))
@interface SharedRegularUserRepository : SharedBase <SharedUserRepository>
- (instancetype)initWithData:(SharedTypesRegularUser *)data api:(SharedMeetacyApi *)api __attribute__((swift_name("init(data:api:)"))) __attribute__((objc_designated_initializer));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)addFriendToken:(id)token completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("addFriend(token:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)deleteFriendToken:(id)token completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("deleteFriend(token:completionHandler:)")));
@property (readonly) SharedFileRepository * _Nullable avatar __attribute__((swift_name("avatar")));
@property (readonly) SharedTypesRegularUser *data __attribute__((swift_name("data")));
@property (readonly) id id __attribute__((swift_name("id")));
@property (readonly) id<SharedTypesRelationship> isFriend __attribute__((swift_name("isFriend")));
@property (readonly) NSString *nickname __attribute__((swift_name("nickname")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SelfUserRepository")))
@interface SharedSelfUserRepository : SharedBase <SharedUserRepository>
- (instancetype)initWithData:(SharedTypesSelfUser *)data api:(SharedAuthorizedMeetacyApi *)api __attribute__((swift_name("init(data:api:)"))) __attribute__((objc_designated_initializer));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)editedNickname:(id<SharedTypesOptional>)nickname avatarId:(id<SharedTypesOptional>)avatarId completionHandler:(void (^)(SharedSelfUserRepository * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("edited(nickname:avatarId:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)editedNickname:(NSString *)nickname avatarId:(id _Nullable)avatarId completionHandler_:(void (^)(SharedSelfUserRepository * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("edited(nickname:avatarId:completionHandler_:)")));
@property (readonly) SharedAuthorizedMeetacyApi *api __attribute__((swift_name("api")));
@property (readonly) SharedAuthorizedAuthApi *auth __attribute__((swift_name("auth")));
@property (readonly) SharedFileRepository * _Nullable avatar __attribute__((swift_name("avatar")));
@property (readonly) SharedTypesSelfUser *data __attribute__((swift_name("data")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("UserRepositoryCompanion")))
@interface SharedUserRepositoryCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedUserRepositoryCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedUserRepository>)ofToken:(id)token data:(id<SharedTypesUser>)data api:(SharedMeetacyApi *)api __attribute__((swift_name("of(token:data:api:)")));
- (id<SharedUserRepository>)ofData:(id<SharedTypesUser>)data api:(SharedAuthorizedMeetacyApi *)api __attribute__((swift_name("of(data:api:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("UsersApi")))
@interface SharedUsersApi : SharedBase
- (instancetype)initWithApi:(SharedMeetacyApi *)api __attribute__((swift_name("init(api:)"))) __attribute__((objc_designated_initializer));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)editToken:(id)token nickname:(id<SharedTypesOptional>)nickname avatarId:(id<SharedTypesOptional>)avatarId completionHandler:(void (^)(SharedSelfUserRepository * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("edit(token:nickname:avatarId:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)editToken:(id)token nickname:(NSString *)nickname avatarId:(id _Nullable)avatarId completionHandler_:(void (^)(SharedSelfUserRepository * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("edit(token:nickname:avatarId:completionHandler_:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)getToken:(id)token userId:(id)userId completionHandler:(void (^)(id<SharedTypesUser> _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("get(token:userId:completionHandler:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("AuthorizedMeetingRepository")))
@interface SharedAuthorizedMeetingRepository : SharedBase
- (instancetype)initWithData:(SharedTypesMeeting *)data api:(SharedAuthorizedMeetacyApi *)api __attribute__((swift_name("init(data:api:)"))) __attribute__((objc_designated_initializer));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)editedTitle:(id<SharedTypesOptional>)title date:(id<SharedTypesOptional>)date location:(id<SharedTypesOptional>)location description:(id<SharedTypesOptional>)description avatarId:(id<SharedTypesOptional>)avatarId visibility:(id<SharedTypesOptional>)visibility completionHandler:(void (^)(SharedAuthorizedMeetingRepository * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("edited(title:date:location:description:avatarId:visibility:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)editedTitle:(NSString *)title date:(id)date location:(SharedTypesLocation *)location description:(NSString * _Nullable)description avatarId:(id _Nullable)avatarId visibility:(SharedTypesMeetingVisibility *)visibility completionHandler_:(void (^)(SharedAuthorizedMeetingRepository * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("edited(title:date:location:description:avatarId:visibility:completionHandler_:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)participateWithCompletionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("participate(completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)updatedWithCompletionHandler:(void (^)(SharedAuthorizedMeetingRepository * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("updated(completionHandler:)")));
@property (readonly) SharedFileRepository * _Nullable avatar __attribute__((swift_name("avatar")));
@property (readonly) SharedMeetingRepository *base __attribute__((swift_name("base")));
@property (readonly) id<SharedTypesUser> creator __attribute__((swift_name("creator")));
@property (readonly) SharedTypesMeeting *data __attribute__((swift_name("data")));
@property (readonly) id date __attribute__((swift_name("date")));
@property (readonly) NSString * _Nullable description_ __attribute__((swift_name("description_")));
@property (readonly) id id __attribute__((swift_name("id")));
@property (readonly) BOOL isParticipating __attribute__((swift_name("isParticipating")));
@property (readonly) SharedTypesLocation *location __attribute__((swift_name("location")));
@property (readonly) SharedAuthorizedMeetingParticipantsRepository *participants __attribute__((swift_name("participants")));
@property (readonly) int32_t participantsCount __attribute__((swift_name("participantsCount")));
@property (readonly) NSArray<id<SharedTypesUser>> *previewParticipants __attribute__((swift_name("previewParticipants")));
@property (readonly) NSString *title __attribute__((swift_name("title")));
@property (readonly) SharedTypesMeetingVisibility *visibility __attribute__((swift_name("visibility")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("AuthorizedMeetingsApi")))
@interface SharedAuthorizedMeetingsApi : SharedBase
- (instancetype)initWithApi:(SharedAuthorizedMeetacyApi *)api __attribute__((swift_name("init(api:)"))) __attribute__((objc_designated_initializer));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)createTitle:(NSString *)title date:(id)date location:(SharedTypesLocation *)location description:(NSString * _Nullable)description visibility:(SharedTypesMeetingVisibility *)visibility completionHandler:(void (^)(SharedAuthorizedMeetingRepository * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("create(title:date:location:description:visibility:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)editMeetingId:(id)meetingId title:(id<SharedTypesOptional>)title date:(id<SharedTypesOptional>)date location:(id<SharedTypesOptional>)location description:(id<SharedTypesOptional>)description avatarId:(id<SharedTypesOptional>)avatarId visibility:(id<SharedTypesOptional>)visibility completionHandler:(void (^)(SharedAuthorizedMeetingRepository * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("edit(meetingId:title:date:location:description:avatarId:visibility:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)editMeetingId:(id)meetingId title:(NSString *)title date:(id)date location:(SharedTypesLocation *)location description:(NSString * _Nullable)description avatarId:(id _Nullable)avatarId visibility:(SharedTypesMeetingVisibility *)visibility completionHandler_:(void (^)(SharedAuthorizedMeetingRepository * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("edit(meetingId:title:date:location:description:avatarId:visibility:completionHandler_:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)getMeetingId:(id)meetingId completionHandler:(void (^)(SharedAuthorizedMeetingRepository * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("get(meetingId:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)participateMeetingId:(id)meetingId completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("participate(meetingId:completionHandler:)")));
@property (readonly) SharedMeetingsApi *base __attribute__((swift_name("base")));
@property (readonly) SharedAuthorizedMeetingsHistoryApi *history __attribute__((swift_name("history")));
@property (readonly) SharedAuthorizedMeetingsMapApi *map __attribute__((swift_name("map")));
@property (readonly) SharedAuthorizedMeetingParticipantsApi *participants __attribute__((swift_name("participants")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("MeetingRepository")))
@interface SharedMeetingRepository : SharedBase
- (instancetype)initWithData:(SharedTypesMeeting *)data api:(SharedMeetacyApi *)api __attribute__((swift_name("init(data:api:)"))) __attribute__((objc_designated_initializer));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)editedToken:(id)token title:(id<SharedTypesOptional>)title date:(id<SharedTypesOptional>)date location:(id<SharedTypesOptional>)location description:(id<SharedTypesOptional>)description avatarId:(id<SharedTypesOptional>)avatarId visibility:(id<SharedTypesOptional>)visibility completionHandler:(void (^)(SharedMeetingRepository * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("edited(token:title:date:location:description:avatarId:visibility:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)editedToken:(id)token title:(NSString *)title date:(id)date location:(SharedTypesLocation *)location description:(NSString * _Nullable)description avatarId:(id _Nullable)avatarId visibility:(SharedTypesMeetingVisibility *)visibility completionHandler_:(void (^)(SharedMeetingRepository * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("edited(token:title:date:location:description:avatarId:visibility:completionHandler_:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)participateToken:(id)token completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("participate(token:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)updatedToken:(id)token completionHandler:(void (^)(SharedMeetingRepository * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("updated(token:completionHandler:)")));
@property (readonly) SharedFileRepository * _Nullable avatar __attribute__((swift_name("avatar")));
@property (readonly) id<SharedTypesUser> creator __attribute__((swift_name("creator")));
@property (readonly) SharedTypesMeeting *data __attribute__((swift_name("data")));
@property (readonly) id date __attribute__((swift_name("date")));
...
@property (readonly) BOOL isParticipating __attribute__((swift_name("isParticipating")));
@property (readonly) SharedTypesLocation *location __attribute__((swift_name("location")));
@property (readonly) SharedMeetingParticipantsRepository *participants __attribute__((swift_name("participants")));
@property (readonly) int32_t participantsCount __attribute__((swift_name("participantsCount")));
@property (readonly) NSArray<id<SharedTypesUser>> *previewParticipants __attribute__((swift_name("previewParticipants")));
@property (readonly) NSString *title __attribute__((swift_name("title")));
@property (readonly) SharedTypesMeetingVisibility *visibility __attribute__((swift_name("visibility")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("MeetingsApi")))
@interface SharedMeetingsApi : SharedBase
- (instancetype)initWithApi:(SharedMeetacyApi *)api __attribute__((swift_name("init(api:)"))) __attribute__((objc_designated_initializer));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)createToken:(id)token title:(NSString *)title date:(id)date location:(SharedTypesLocation *)location description:(NSString * _Nullable)description visibility:(SharedTypesMeetingVisibility *)visibility completionHandler:(void (^)(SharedMeetingRepository * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("create(token:title:date:location:description:visibility:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)editToken:(id)token meetingId:(id)meetingId title:(id<SharedTypesOptional>)title date:(id<SharedTypesOptional>)date location:(id<SharedTypesOptional>)location description:(id<SharedTypesOptional>)description avatarId:(id<SharedTypesOptional>)avatarId visibility:(id<SharedTypesOptional>)visibility completionHandler:(void (^)(SharedMeetingRepository * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("edit(token:meetingId:title:date:location:description:avatarId:visibility:completionHandler:)")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)getToken:(id)token meetingId:(id)meetingId completionHandler:(void (^)(SharedMeetingRepository * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("get(token:meetingId:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)participateToken:(id)token meetingId:(id)meetingId completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("participate(token:meetingId:completionHandler:)")));
@property (readonly) SharedMeetingsHistoryApi *history __attribute__((swift_name("history")));
@property (readonly) SharedMeetingsMapApi *map __attribute__((swift_name("map")));
@property (readonly) SharedMeetingParticipantsApi *participants __attribute__((swift_name("participants")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("AuthorizedMeetingsMapApi")))
@interface SharedAuthorizedMeetingsMapApi : SharedBase
- (instancetype)initWithApi:(SharedAuthorizedMeetacyApi *)api __attribute__((swift_name("init(api:)"))) __attribute__((objc_designated_initializer));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)listLocation:(SharedTypesLocation *)location completionHandler:(void (^)(NSArray<SharedAuthorizedMeetingRepository *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("list(location:completionHandler:)")));
@property (readonly) SharedMeetingsMapApi *base __attribute__((swift_name("base")));
@property (readonly) id token __attribute__((swift_name("token")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("MeetingsMapApi")))
@interface SharedMeetingsMapApi : SharedBase
- (instancetype)initWithApi:(SharedMeetacyApi *)api __attribute__((swift_name("init(api:)"))) __attribute__((objc_designated_initializer));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)listToken:(id)token location:(SharedTypesLocation *)location completionHandler:(void (^)(NSArray<SharedMeetingRepository *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("list(token:location:completionHandler:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("AuthorizedMeetingParticipantsApi")))
@interface SharedAuthorizedMeetingParticipantsApi : SharedBase
- (instancetype)initWithApi:(SharedAuthorizedMeetacyApi *)api __attribute__((swift_name("init(api:)"))) __attribute__((objc_designated_initializer));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)listMeetingId:(id)meetingId amount:(int32_t)amount pagingId:(id _Nullable)pagingId completionHandler:(void (^)(id<SharedTypesPagingRepository> _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("list(meetingId:amount:pagingId:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)pagingMeetingId:(id)meetingId chunkSize:(int32_t)chunkSize startPagingId:(id _Nullable)startPagingId limit:(id _Nullable)limit completionHandler:(void (^)(id<SharedTypesPagingSource> _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("paging(meetingId:chunkSize:startPagingId:limit:completionHandler:)")));
@property (readonly) SharedMeetingParticipantsApi *base __attribute__((swift_name("base")));
@property (readonly) id token __attribute__((swift_name("token")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("AuthorizedMeetingParticipantsRepository")))
@interface SharedAuthorizedMeetingParticipantsRepository : SharedBase
- (instancetype)initWithMeetingId:(id)meetingId api:(SharedAuthorizedMeetacyApi *)api __attribute__((swift_name("init(meetingId:api:)"))) __attribute__((objc_designated_initializer));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)listAmount:(int32_t)amount pagingId:(id _Nullable)pagingId completionHandler:(void (^)(id<SharedTypesPagingRepository> _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("list(amount:pagingId:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)pagingChunkSize:(int32_t)chunkSize startPagingId:(id _Nullable)startPagingId limit:(id _Nullable)limit completionHandler:(void (^)(id<SharedTypesPagingSource> _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("paging(chunkSize:startPagingId:limit:completionHandler:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("MeetingParticipantsApi")))
@interface SharedMeetingParticipantsApi : SharedBase
- (instancetype)initWithApi:(SharedMeetacyApi *)api __attribute__((swift_name("init(api:)"))) __attribute__((objc_designated_initializer));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)listToken:(id)token meetingId:(id)meetingId amount:(int32_t)amount pagingId:(id _Nullable)pagingId completionHandler:(void (^)(id<SharedTypesPagingRepository> _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("list(token:meetingId:amount:pagingId:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)pagingToken:(id)token meetingId:(id)meetingId chunkSize:(int32_t)chunkSize startPagingId:(id _Nullable)startPagingId limit:(id _Nullable)limit completionHandler:(void (^)(id<SharedTypesPagingSource> _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("paging(token:meetingId:chunkSize:startPagingId:limit:completionHandler:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("MeetingParticipantsRepository")))
@interface SharedMeetingParticipantsRepository : SharedBase
- (instancetype)initWithMeetingId:(id)meetingId api:(SharedMeetacyApi *)api __attribute__((swift_name("init(meetingId:api:)"))) __attribute__((objc_designated_initializer));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)listToken:(id)token amount:(int32_t)amount pagingId:(id _Nullable)pagingId completionHandler:(void (^)(id<SharedTypesPagingRepository> _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("list(token:amount:pagingId:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)pagingToken:(id)token chunkSize:(int32_t)chunkSize startPagingId:(id _Nullable)startPagingId limit:(id _Nullable)limit completionHandler:(void (^)(id<SharedTypesPagingSource> _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("paging(token:chunkSize:startPagingId:limit:completionHandler:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("AuthorizedMeetingsHistoryApi")))
@interface SharedAuthorizedMeetingsHistoryApi : SharedBase
- (instancetype)initWithApi:(SharedAuthorizedMeetacyApi *)api __attribute__((swift_name("init(api:)"))) __attribute__((objc_designated_initializer));
...
*/
- (void)listAmount:(int32_t)amount pagingId:(id _Nullable)pagingId completionHandler:(void (^)(id<SharedTypesPagingRepository> _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("list(amount:pagingId:completionHandler:)")));
- (id<SharedTypesPagingSource>)pagingChunkSize:(int32_t)chunkSize startPagingId:(id _Nullable)startPagingId limit:(id _Nullable)limit __attribute__((swift_name("paging(chunkSize:startPagingId:limit:)")));
@property (readonly) SharedMeetingsHistoryApi *base __attribute__((swift_name("base")));
@property (readonly) id token __attribute__((swift_name("token")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("MeetingsHistoryApi")))
@interface SharedMeetingsHistoryApi : SharedBase
- (instancetype)initWithApi:(SharedMeetacyApi *)api __attribute__((swift_name("init(api:)"))) __attribute__((objc_designated_initializer));
...
*/
- (void)listToken:(id)token amount:(int32_t)amount pagingId:(id _Nullable)pagingId completionHandler:(void (^)(id<SharedTypesPagingRepository> _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("list(token:amount:pagingId:completionHandler:)")));
- (id<SharedTypesPagingSource>)pagingToken:(id)token chunkSize:(int32_t)chunkSize startPagingId:(id _Nullable)startPagingId limit:(id _Nullable)limit __attribute__((swift_name("paging(token:chunkSize:startPagingId:limit:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("AuthorizedFilesApi")))
@interface SharedAuthorizedFilesApi : SharedBase
- (instancetype)initWithApi:(SharedAuthorizedMeetacyApi *)api __attribute__((swift_name("init(api:)"))) __attribute__((objc_designated_initializer));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)getFileId:(id)fileId completionHandler:(void (^)(SharedDownloadableFile * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("get(fileId:completionHandler:)")));
- (id)getFileUrlId:(id)id __attribute__((swift_name("getFileUrl(id:)")));
@property (readonly) SharedFilesApi *base __attribute__((swift_name("base")));
@property (readonly) id token __attribute__((swift_name("token")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("DownloadableFile")))
@interface SharedDownloadableFile : SharedBase
- (instancetype)initWithId:(id)id size:(int64_t)size input:(id<SharedInputSource>)input __attribute__((swift_name("init(id:size:input:)"))) __attribute__((objc_designated_initializer));
- (SharedDownloadableFile *)doCopyId:(id)id size:(int64_t)size input:(id<SharedInputSource>)input __attribute__((swift_name("doCopy(id:size:input:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) id id __attribute__((swift_name("id")));
@property (readonly) id<SharedInputSource> input __attribute__((swift_name("input")));
@property (readonly) int64_t size __attribute__((swift_name("size")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("FileRepository")))
@interface SharedFileRepository : SharedBase
- (instancetype)initWithId:(id)id api:(SharedMeetacyApi *)api __attribute__((swift_name("init(id:api:)"))) __attribute__((objc_designated_initializer));
@property (readonly) SharedMeetacyApi *api __attribute__((swift_name("api")));
@property (readonly) id id __attribute__((swift_name("id")));
@property (readonly) id<SharedInputSource> input __attribute__((swift_name("input")));
@property (readonly) id url __attribute__((swift_name("url")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("FilesApi")))
@interface SharedFilesApi : SharedBase
- (instancetype)initWithApi:(SharedMeetacyApi *)api __attribute__((swift_name("init(api:)"))) __attribute__((objc_designated_initializer));
...
*/
- (void)getFileId:(id)fileId completionHandler:(void (^)(SharedDownloadableFile * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("get(fileId:completionHandler:)")));
- (id)getUrlId:(id)id __attribute__((swift_name("getUrl(id:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)uploadToken:(id)token source:(SharedUploadableFile *)source completionHandler:(void (^)(id _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("upload(token:source:completionHandler:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("UploadableFile")))
@interface SharedUploadableFile : SharedBase
- (instancetype)initWithSize:(int64_t)size input:(id<SharedInputSource>)input __attribute__((swift_name("init(size:input:)"))) __attribute__((objc_designated_initializer));
- (SharedUploadableFile *)doCopySize:(int64_t)size input:(id<SharedInputSource>)input __attribute__((swift_name("doCopy(size:input:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) id<SharedInputSource> input __attribute__((swift_name("input")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("AuthorizedFriendsApi")))
@interface SharedAuthorizedFriendsApi : SharedBase
- (instancetype)initWithApi:(SharedAuthorizedMeetacyApi *)api __attribute__((swift_name("init(api:)"))) __attribute__((objc_designated_initializer));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)addFriendId:(id)friendId completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("add(friendId:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)deleteFriendId:(id)friendId completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("delete(friendId:completionHandler:)")));
...
- (void)listAmount:(int32_t)amount pagingId:(id _Nullable)pagingId completionHandler:(void (^)(id<SharedTypesPagingRepository> _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("list(amount:pagingId:completionHandler:)")));
- (id<SharedTypesPagingSource>)pagingChunkSize:(int32_t)chunkSize startPagingId:(id _Nullable)startPagingId limit:(id _Nullable)limit __attribute__((swift_name("paging(chunkSize:startPagingId:limit:)")));
@property (readonly) SharedFriendsApi *base __attribute__((swift_name("base")));
@property (readonly) SharedAuthorizedFriendsLocationApi *location __attribute__((swift_name("location")));
@property (readonly) id token __attribute__((swift_name("token")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("FriendsApi")))
@interface SharedFriendsApi : SharedBase
- (instancetype)initWithApi:(SharedMeetacyApi *)api __attribute__((swift_name("init(api:)"))) __attribute__((objc_designated_initializer));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)addToken:(id)token friendId:(id)friendId completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("add(token:friendId:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)deleteToken:(id)token friendId:(id)friendId completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("delete(token:friendId:completionHandler:)")));
...
- (void)listToken:(id)token amount:(int32_t)amount pagingId:(id _Nullable)pagingId completionHandler:(void (^)(id<SharedTypesPagingRepository> _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("list(token:amount:pagingId:completionHandler:)")));
- (id<SharedTypesPagingSource>)pagingToken:(id)token chunkSize:(int32_t)chunkSize startPagingId:(id _Nullable)startPagingId limit:(id _Nullable)limit __attribute__((swift_name("paging(token:chunkSize:startPagingId:limit:)")));
@property (readonly) SharedFriendsLocationApi *location __attribute__((swift_name("location")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("AuthorizedFriendsLocationApi")))
@interface SharedAuthorizedFriendsLocationApi : SharedBase
- (instancetype)initWithApi:(SharedAuthorizedMeetacyApi *)api __attribute__((swift_name("init(api:)"))) __attribute__((objc_designated_initializer));
- (id<SharedKotlinx_coroutines_coreFlow>)streamSelfLocation:(id<SharedKotlinx_coroutines_coreFlow>)selfLocation __attribute__((swift_name("stream(selfLocation:)")));
@property (readonly) SharedFriendsLocationApi *base __attribute__((swift_name("base")));
@property (readonly) id token __attribute__((swift_name("token")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("AuthorizedUserOnMapRepository")))
@interface SharedAuthorizedUserOnMapRepository : SharedBase
- (instancetype)initWithUser:(SharedAuthorizedRegularUserRepository *)user location:(SharedTypesLocation *)location capturedAt:(id)capturedAt __attribute__((swift_name("init(user:location:capturedAt:)"))) __attribute__((objc_designated_initializer));
@property (readonly) id capturedAt __attribute__((swift_name("capturedAt")));
@property (readonly) SharedTypesLocation *location __attribute__((swift_name("location")));
@property (readonly) SharedAuthorizedRegularUserRepository *user __attribute__((swift_name("user")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("FriendsLocationApi")))
@interface SharedFriendsLocationApi : SharedBase
- (instancetype)initWithApi:(SharedMeetacyApi *)api __attribute__((swift_name("init(api:)"))) __attribute__((objc_designated_initializer));
- (id<SharedKotlinx_coroutines_coreFlow>)streamToken:(id)token selfLocation:(id<SharedKotlinx_coroutines_coreFlow>)selfLocation __attribute__((swift_name("stream(token:selfLocation:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("UserOnMapRepository")))
@interface SharedUserOnMapRepository : SharedBase
- (instancetype)initWithUser:(SharedRegularUserRepository *)user location:(SharedTypesLocation *)location capturedAt:(id)capturedAt __attribute__((swift_name("init(user:location:capturedAt:)"))) __attribute__((objc_designated_initializer));
@property (readonly) id capturedAt __attribute__((swift_name("capturedAt")));
@property (readonly) SharedTypesLocation *location __attribute__((swift_name("location")));
@property (readonly) SharedRegularUserRepository *user __attribute__((swift_name("user")));
@end

__attribute__((swift_name("MeetacyRequest")))
@protocol SharedMeetacyRequest
@required
@property (readonly) int32_t apiVersion __attribute__((swift_name("apiVersion")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("AddFriendRequest")))
@interface SharedAddFriendRequest : SharedBase <SharedMeetacyRequest>
- (instancetype)initWithToken:(id)token friendId:(id)friendId __attribute__((swift_name("init(token:friendId:)"))) __attribute__((objc_designated_initializer));
- (SharedAddFriendRequest *)doCopyToken:(id)token friendId:(id)friendId __attribute__((swift_name("doCopy(token:friendId:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) id friendId __attribute__((swift_name("friendId")));
@property (readonly) id token __attribute__((swift_name("token")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ConfirmEmailRequest")))
@interface SharedConfirmEmailRequest : SharedBase <SharedMeetacyRequest>
- (instancetype)initWithEmail:(id)email confirmHash:(id)confirmHash __attribute__((swift_name("init(email:confirmHash:)"))) __attribute__((objc_designated_initializer));
- (SharedConfirmEmailRequest *)doCopyEmail:(id)email confirmHash:(id)confirmHash __attribute__((swift_name("doCopy(email:confirmHash:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) id confirmHash __attribute__((swift_name("confirmHash")));
@property (readonly) id email __attribute__((swift_name("email")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ConfirmEmailRequest.Response")))
@interface SharedConfirmEmailRequestResponse : SharedBase
- (instancetype)initWithStatus:(id<SharedTypesConfirmEmailStatus>)status __attribute__((swift_name("init(status:)"))) __attribute__((objc_designated_initializer));
- (SharedConfirmEmailRequestResponse *)doCopyStatus:(id<SharedTypesConfirmEmailStatus>)status __attribute__((swift_name("doCopy(status:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) id<SharedTypesConfirmEmailStatus> status __attribute__((swift_name("status")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CreateMeetingRequest")))
@interface SharedCreateMeetingRequest : SharedBase <SharedMeetacyRequest>
- (instancetype)initWithToken:(id)token title:(NSString *)title date:(id)date location:(SharedTypesLocation *)location description:(NSString * _Nullable)description visibility:(SharedTypesMeetingVisibility *)visibility __attribute__((swift_name("init(token:title:date:location:description:visibility:)"))) __attribute__((objc_designated_initializer));
@property (readonly) id date __attribute__((swift_name("date")));
@property (readonly) NSString * _Nullable description_ __attribute__((swift_name("description_")));
@property (readonly) SharedTypesLocation *location __attribute__((swift_name("location")));
@property (readonly) NSString *title __attribute__((swift_name("title")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CreateMeetingRequest.Response")))
@interface SharedCreateMeetingRequestResponse : SharedBase
- (instancetype)initWithMeeting:(SharedTypesMeeting *)meeting __attribute__((swift_name("init(meeting:)"))) __attribute__((objc_designated_initializer));
- (SharedCreateMeetingRequestResponse *)doCopyMeeting:(SharedTypesMeeting *)meeting __attribute__((swift_name("doCopy(meeting:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) SharedTypesMeeting *meeting __attribute__((swift_name("meeting")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("DeleteFriendRequest")))
@interface SharedDeleteFriendRequest : SharedBase <SharedMeetacyRequest>
- (instancetype)initWithToken:(id)token friendId:(id)friendId __attribute__((swift_name("init(token:friendId:)"))) __attribute__((objc_designated_initializer));
- (SharedDeleteFriendRequest *)doCopyToken:(id)token friendId:(id)friendId __attribute__((swift_name("doCopy(token:friendId:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) id friendId __attribute__((swift_name("friendId")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("EditMeetingRequest")))
@interface SharedEditMeetingRequest : SharedBase <SharedMeetacyRequest>
- (instancetype)initWithToken:(id)token meetingId:(id)meetingId title:(id<SharedTypesOptional>)title description:(id<SharedTypesOptional>)description location:(id<SharedTypesOptional>)location date:(id<SharedTypesOptional>)date avatarId:(id<SharedTypesOptional>)avatarId visibility:(id<SharedTypesOptional>)visibility __attribute__((swift_name("init(token:meetingId:title:description:location:date:avatarId:visibility:)"))) __attribute__((objc_designated_initializer));
- (SharedEditMeetingRequest *)doCopyToken:(id)token meetingId:(id)meetingId title:(id<SharedTypesOptional>)title description:(id<SharedTypesOptional>)description location:(id<SharedTypesOptional>)location date:(id<SharedTypesOptional>)date avatarId:(id<SharedTypesOptional>)avatarId visibility:(id<SharedTypesOptional>)visibility __attribute__((swift_name("doCopy(token:meetingId:title:description:location:date:avatarId:visibility:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) id<SharedTypesOptional> avatarId __attribute__((swift_name("avatarId")));
@property (readonly) id<SharedTypesOptional> date __attribute__((swift_name("date")));
@property (readonly) id<SharedTypesOptional> description_ __attribute__((swift_name("description_")));
@property (readonly) id<SharedTypesOptional> location __attribute__((swift_name("location")));
@property (readonly) id meetingId __attribute__((swift_name("meetingId")));
@property (readonly) id<SharedTypesOptional> title __attribute__((swift_name("title")));
@property (readonly) id token __attribute__((swift_name("token")));
@property (readonly) id<SharedTypesOptional> visibility __attribute__((swift_name("visibility")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("EditMeetingRequest.Response")))
@interface SharedEditMeetingRequestResponse : SharedBase
- (instancetype)initWithMeeting:(SharedTypesMeeting *)meeting __attribute__((swift_name("init(meeting:)"))) __attribute__((objc_designated_initializer));
- (SharedEditMeetingRequestResponse *)doCopyMeeting:(SharedTypesMeeting *)meeting __attribute__((swift_name("doCopy(meeting:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) SharedTypesMeeting *meeting __attribute__((swift_name("meeting")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("EditUserRequest")))
@interface SharedEditUserRequest : SharedBase <SharedMeetacyRequest>
- (instancetype)initWithToken:(id)token nickname:(id<SharedTypesOptional>)nickname avatarId:(id<SharedTypesOptional>)avatarId __attribute__((swift_name("init(token:nickname:avatarId:)"))) __attribute__((objc_designated_initializer));
- (SharedEditUserRequest *)doCopyToken:(id)token nickname:(id<SharedTypesOptional>)nickname avatarId:(id<SharedTypesOptional>)avatarId __attribute__((swift_name("doCopy(token:nickname:avatarId:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) id<SharedTypesOptional> avatarId __attribute__((swift_name("avatarId")));
@property (readonly) id<SharedTypesOptional> nickname __attribute__((swift_name("nickname")));
@property (readonly) id token __attribute__((swift_name("token")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("EditUserRequest.Response")))
@interface SharedEditUserRequestResponse : SharedBase
- (instancetype)initWithUser:(SharedTypesSelfUser *)user __attribute__((swift_name("init(user:)"))) __attribute__((objc_designated_initializer));
- (SharedEditUserRequestResponse *)doCopyUser:(SharedTypesSelfUser *)user __attribute__((swift_name("doCopy(user:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) SharedTypesSelfUser *user __attribute__((swift_name("user")));
@end

__attribute__((swift_name("FlowMeetacyRequest")))
@protocol SharedFlowMeetacyRequest <SharedMeetacyRequest>
@required
@property (readonly) id<SharedKotlinx_coroutines_coreFlowCollector> collector __attribute__((swift_name("collector")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("EmitFriendsLocationRequest")))
@interface SharedEmitFriendsLocationRequest : SharedBase <SharedFlowMeetacyRequest>
- (instancetype)initWithToken:(id)token selfLocation:(id<SharedKotlinx_coroutines_coreFlow>)selfLocation collector:(id<SharedKotlinx_coroutines_coreFlowCollector>)collector __attribute__((swift_name("init(token:selfLocation:collector:)"))) __attribute__((objc_designated_initializer));
- (SharedEmitFriendsLocationRequest *)doCopyToken:(id)token selfLocation:(id<SharedKotlinx_coroutines_coreFlow>)selfLocation collector:(id<SharedKotlinx_coroutines_coreFlowCollector>)collector __attribute__((swift_name("doCopy(token:selfLocation:collector:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) id<SharedKotlinx_coroutines_coreFlowCollector> collector __attribute__((swift_name("collector")));
@property (readonly) id<SharedKotlinx_coroutines_coreFlow> selfLocation __attribute__((swift_name("selfLocation")));
@property (readonly) id token __attribute__((swift_name("token")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("EmitFriendsLocationRequest.Update")))
@interface SharedEmitFriendsLocationRequestUpdate : SharedBase
- (instancetype)initWithUser:(SharedTypesUserLocationSnapshot *)user __attribute__((swift_name("init(user:)"))) __attribute__((objc_designated_initializer));
- (SharedEmitFriendsLocationRequestUpdate *)doCopyUser:(SharedTypesUserLocationSnapshot *)user __attribute__((swift_name("doCopy(user:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) SharedTypesUserLocationSnapshot *user __attribute__((swift_name("user")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("GenerateAuthRequest")))
@interface SharedGenerateAuthRequest : SharedBase <SharedMeetacyRequest>
- (instancetype)initWithNickname:(NSString *)nickname __attribute__((swift_name("init(nickname:)"))) __attribute__((objc_designated_initializer));
- (SharedGenerateAuthRequest *)doCopyNickname:(NSString *)nickname __attribute__((swift_name("doCopy(nickname:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *nickname __attribute__((swift_name("nickname")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("GenerateAuthRequest.Response")))
@interface SharedGenerateAuthRequestResponse : SharedBase
- (instancetype)initWithToken:(id)token __attribute__((swift_name("init(token:)"))) __attribute__((objc_designated_initializer));
- (SharedGenerateAuthRequestResponse *)doCopyToken:(id)token __attribute__((swift_name("doCopy(token:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) id token __attribute__((swift_name("token")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("GetFileRequest")))
@interface SharedGetFileRequest : SharedBase <SharedMeetacyRequest>
- (instancetype)initWithFileId:(id)fileId __attribute__((swift_name("init(fileId:)"))) __attribute__((objc_designated_initializer));
- (SharedGetFileRequest *)doCopyFileId:(id)fileId __attribute__((swift_name("doCopy(fileId:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) id fileId __attribute__((swift_name("fileId")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("GetFileRequest.Response")))
@interface SharedGetFileRequestResponse : SharedBase
- (instancetype)initWithFile:(SharedDownloadableFile *)file __attribute__((swift_name("init(file:)"))) __attribute__((objc_designated_initializer));
- (SharedGetFileRequestResponse *)doCopyFile:(SharedDownloadableFile *)file __attribute__((swift_name("doCopy(file:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) SharedDownloadableFile *file __attribute__((swift_name("file")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("GetMeRequest")))
@interface SharedGetMeRequest : SharedBase <SharedMeetacyRequest>
- (instancetype)initWithToken:(id)token __attribute__((swift_name("init(token:)"))) __attribute__((objc_designated_initializer));
- (SharedGetMeRequest *)doCopyToken:(id)token __attribute__((swift_name("doCopy(token:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) id token __attribute__((swift_name("token")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("GetMeRequest.Response")))
@interface SharedGetMeRequestResponse : SharedBase
- (instancetype)initWithMe:(SharedTypesSelfUser *)me __attribute__((swift_name("init(me:)"))) __attribute__((objc_designated_initializer));
- (SharedGetMeRequestResponse *)doCopyMe:(SharedTypesSelfUser *)me __attribute__((swift_name("doCopy(me:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) SharedTypesSelfUser *me __attribute__((swift_name("me")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("GetMeetingRequest")))
@interface SharedGetMeetingRequest : SharedBase <SharedMeetacyRequest>
- (instancetype)initWithToken:(id)token meetingId:(id)meetingId __attribute__((swift_name("init(token:meetingId:)"))) __attribute__((objc_designated_initializer));
- (SharedGetMeetingRequest *)doCopyToken:(id)token meetingId:(id)meetingId __attribute__((swift_name("doCopy(token:meetingId:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) id meetingId __attribute__((swift_name("meetingId")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("GetMeetingRequest.Response")))
@interface SharedGetMeetingRequestResponse : SharedBase
- (instancetype)initWithMeeting:(SharedTypesMeeting *)meeting __attribute__((swift_name("init(meeting:)"))) __attribute__((objc_designated_initializer));
- (SharedGetMeetingRequestResponse *)doCopyMeeting:(SharedTypesMeeting *)meeting __attribute__((swift_name("doCopy(meeting:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) SharedTypesMeeting *meeting __attribute__((swift_name("meeting")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("GetUserRequest")))
@interface SharedGetUserRequest : SharedBase <SharedMeetacyRequest>
- (instancetype)initWithToken:(id)token userId:(id)userId __attribute__((swift_name("init(token:userId:)"))) __attribute__((objc_designated_initializer));
- (SharedGetUserRequest *)doCopyToken:(id)token userId:(id)userId __attribute__((swift_name("doCopy(token:userId:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) id token __attribute__((swift_name("token")));
@property (readonly) id userId __attribute__((swift_name("userId")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("GetUserRequest.Response")))
@interface SharedGetUserRequestResponse : SharedBase
- (instancetype)initWithUser:(id<SharedTypesUser>)user __attribute__((swift_name("init(user:)"))) __attribute__((objc_designated_initializer));
- (SharedGetUserRequestResponse *)doCopyUser:(id<SharedTypesUser>)user __attribute__((swift_name("doCopy(user:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) id<SharedTypesUser> user __attribute__((swift_name("user")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("LinkEmailRequest")))
@interface SharedLinkEmailRequest : SharedBase <SharedMeetacyRequest>
- (instancetype)initWithToken:(id)token email:(id)email __attribute__((swift_name("init(token:email:)"))) __attribute__((objc_designated_initializer));
- (SharedLinkEmailRequest *)doCopyToken:(id)token email:(id)email __attribute__((swift_name("doCopy(token:email:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) id email __attribute__((swift_name("email")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ListFriendsRequest")))
@interface SharedListFriendsRequest : SharedBase <SharedMeetacyRequest>
- (instancetype)initWithToken:(id)token amount:(int32_t)amount pagingId:(id _Nullable)pagingId __attribute__((swift_name("init(token:amount:pagingId:)"))) __attribute__((objc_designated_initializer));
- (SharedListFriendsRequest *)doCopyToken:(id)token amount:(int32_t)amount pagingId:(id _Nullable)pagingId __attribute__((swift_name("doCopy(token:amount:pagingId:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) int32_t amount __attribute__((swift_name("amount")));
@property (readonly) id _Nullable pagingId __attribute__((swift_name("pagingId")));
@property (readonly) id token __attribute__((swift_name("token")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ListFriendsRequest.Response")))
@interface SharedListFriendsRequestResponse : SharedBase
- (instancetype)initWithPaging:(SharedTypesPagingResponse<SharedTypesRegularUser *> *)paging __attribute__((swift_name("init(paging:)"))) __attribute__((objc_designated_initializer));
- (SharedListFriendsRequestResponse *)doCopyPaging:(SharedTypesPagingResponse<SharedTypesRegularUser *> *)paging __attribute__((swift_name("doCopy(paging:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) SharedTypesPagingResponse<SharedTypesRegularUser *> *paging __attribute__((swift_name("paging")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ListMeetingParticipantsRequest")))
@interface SharedListMeetingParticipantsRequest : SharedBase <SharedMeetacyRequest>
- (instancetype)initWithToken:(id)token meetingId:(id)meetingId amount:(int32_t)amount pagingId:(id _Nullable)pagingId __attribute__((swift_name("init(token:meetingId:amount:pagingId:)"))) __attribute__((objc_designated_initializer));
- (SharedListMeetingParticipantsRequest *)doCopyToken:(id)token meetingId:(id)meetingId amount:(int32_t)amount pagingId:(id _Nullable)pagingId __attribute__((swift_name("doCopy(token:meetingId:amount:pagingId:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) int32_t amount __attribute__((swift_name("amount")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ListMeetingParticipantsRequest.Response")))
@interface SharedListMeetingParticipantsRequestResponse : SharedBase
- (instancetype)initWithPaging:(SharedTypesPagingResponse<id<SharedTypesUser>> *)paging __attribute__((swift_name("init(paging:)"))) __attribute__((objc_designated_initializer));
- (SharedListMeetingParticipantsRequestResponse *)doCopyPaging:(SharedTypesPagingResponse<id<SharedTypesUser>> *)paging __attribute__((swift_name("doCopy(paging:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) SharedTypesPagingResponse<id<SharedTypesUser>> *paging __attribute__((swift_name("paging")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ListMeetingsHistoryRequest")))
@interface SharedListMeetingsHistoryRequest : SharedBase <SharedMeetacyRequest>
- (instancetype)initWithToken:(id)token amount:(int32_t)amount pagingId:(id _Nullable)pagingId __attribute__((swift_name("init(token:amount:pagingId:)"))) __attribute__((objc_designated_initializer));
- (SharedListMeetingsHistoryRequest *)doCopyToken:(id)token amount:(int32_t)amount pagingId:(id _Nullable)pagingId __attribute__((swift_name("doCopy(token:amount:pagingId:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) int32_t amount __attribute__((swift_name("amount")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ListMeetingsHistoryRequest.Response")))
@interface SharedListMeetingsHistoryRequestResponse : SharedBase
- (instancetype)initWithPaging:(SharedTypesPagingResponse<SharedTypesMeeting *> *)paging __attribute__((swift_name("init(paging:)"))) __attribute__((objc_designated_initializer));
- (SharedListMeetingsHistoryRequestResponse *)doCopyPaging:(SharedTypesPagingResponse<SharedTypesMeeting *> *)paging __attribute__((swift_name("doCopy(paging:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) SharedTypesPagingResponse<SharedTypesMeeting *> *paging __attribute__((swift_name("paging")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ListMeetingsMapRequest")))
@interface SharedListMeetingsMapRequest : SharedBase <SharedMeetacyRequest>
- (instancetype)initWithToken:(id)token location:(SharedTypesLocation *)location __attribute__((swift_name("init(token:location:)"))) __attribute__((objc_designated_initializer));
- (SharedListMeetingsMapRequest *)doCopyToken:(id)token location:(SharedTypesLocation *)location __attribute__((swift_name("doCopy(token:location:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) SharedTypesLocation *location __attribute__((swift_name("location")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ListMeetingsMapRequest.Response")))
@interface SharedListMeetingsMapRequestResponse : SharedBase
- (instancetype)initWithMeetings:(NSArray<SharedTypesMeeting *> *)meetings __attribute__((swift_name("init(meetings:)"))) __attribute__((objc_designated_initializer));
- (SharedListMeetingsMapRequestResponse *)doCopyMeetings:(NSArray<SharedTypesMeeting *> *)meetings __attribute__((swift_name("doCopy(meetings:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSArray<SharedTypesMeeting *> *meetings __attribute__((swift_name("meetings")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ParticipateMeetingRequest")))
@interface SharedParticipateMeetingRequest : SharedBase <SharedMeetacyRequest>
- (instancetype)initWithToken:(id)token meetingId:(id)meetingId __attribute__((swift_name("init(token:meetingId:)"))) __attribute__((objc_designated_initializer));
- (SharedParticipateMeetingRequest *)doCopyToken:(id)token meetingId:(id)meetingId __attribute__((swift_name("doCopy(token:meetingId:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) id meetingId __attribute__((swift_name("meetingId")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("UploadFileRequest")))
@interface SharedUploadFileRequest : SharedBase <SharedMeetacyRequest>
- (instancetype)initWithToken:(id)token file:(SharedUploadableFile *)file __attribute__((swift_name("init(token:file:)"))) __attribute__((objc_designated_initializer));
@property (readonly) SharedUploadableFile *file __attribute__((swift_name("file")));
@property (readonly) id token __attribute__((swift_name("token")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("UploadFileRequest.Response")))
@interface SharedUploadFileRequestResponse : SharedBase
- (instancetype)initWithFileId:(id)fileId __attribute__((swift_name("init(fileId:)"))) __attribute__((objc_designated_initializer));
- (SharedUploadFileRequestResponse *)doCopyFileId:(id)fileId __attribute__((swift_name("doCopy(fileId:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) id fileId __attribute__((swift_name("fileId")));
...
__attribute__((swift_name("IOChannel")))
@protocol SharedIOChannel
@required
...
@property (readonly) id<SharedInput> input __attribute__((swift_name("input")));
@property (readonly) id<SharedOutput> output __attribute__((swift_name("output")));
@end

__attribute__((swift_name("IOSource")))
@protocol SharedIOSource
@required
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)openScope:(id<SharedKotlinx_coroutines_coreCoroutineScope>)scope completionHandler:(void (^)(id<SharedIOChannel> _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("open(scope:completionHandler:)")));
@property (readonly) id<SharedInputSource> input __attribute__((swift_name("input")));
@property (readonly) id<SharedOutputSource> output __attribute__((swift_name("output")));
@end

__attribute__((swift_name("Input")))
@protocol SharedInput
@required
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)readDestination:(SharedByteArrayView *)destination completionHandler:(void (^)(SharedInt * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("read(destination:completionHandler:)")));
@end

__attribute__((swift_name("InputSource")))
@protocol SharedInputSource
@required
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)writeSource:(SharedByteArrayView *)source completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("write(source:completionHandler:)")));
@end

__attribute__((swift_name("OutputSource")))
@protocol SharedOutputSource
@required
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)openScope:(id<SharedKotlinx_coroutines_coreCoroutineScope>)scope completionHandler:(void (^)(id<SharedOutput> _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("open(scope:completionHandler:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ByteArrayView")))
@interface SharedByteArrayView : SharedBase
...
- (instancetype)initWithUnderlying:(SharedKotlinByteArray *)underlying fromIndex:(int32_t)fromIndex toIndex:(int32_t)toIndex __attribute__((swift_name("init(underlying:fromIndex:toIndex:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedByteArrayViewCompanion *companion __attribute__((swift_name("companion")));
- (SharedByteArrayView *)adjustBoundsFromIndex:(int32_t)fromIndex toIndex:(int32_t)toIndex __attribute__((swift_name("adjustBounds(fromIndex:toIndex:)")));
- (SharedByteArrayView *)doCopy __attribute__((swift_name("doCopy()")));
- (SharedKotlinByteArray *)extractData __attribute__((swift_name("extractData()")));
- (int8_t)getIndex:(int32_t)index __attribute__((swift_name("get(index:)")));
- (SharedKotlinByteIterator *)iterator __attribute__((swift_name("iterator()")));
- (void)setIndex:(int32_t)index byte:(int8_t)byte __attribute__((swift_name("set(index:byte:)")));
- (void)setDataBytes:(SharedKotlinByteArray *)bytes __attribute__((swift_name("setData(bytes:)")));
@property (readonly) id byteBuffer __attribute__((swift_name("byteBuffer")));
@property (readonly) int32_t fromIndex __attribute__((swift_name("fromIndex")));
@property (readonly) SharedKotlinIntRange *indices __attribute__((swift_name("indices")));
@property (readonly) int32_t size __attribute__((swift_name("size")));
@property (readonly) int32_t toIndex __attribute__((swift_name("toIndex")));
@property (readonly) SharedKotlinByteArray *underlying __attribute__((swift_name("underlying")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ByteArrayView.Companion")))
@interface SharedByteArrayViewCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedByteArrayViewCompanion *shared __attribute__((swift_name("shared")));
@property (readonly) SharedByteArrayView *Empty __attribute__((swift_name("Empty")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("MeetacyIOException")))
@interface SharedMeetacyIOException : SharedKotlinRuntimeException
- (instancetype)initWithMessage:(NSString * _Nullable)message cause:(SharedKotlinThrowable * _Nullable)cause __attribute__((swift_name("init(message:cause:)"))) __attribute__((objc_designated_initializer));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
- (instancetype)initWithMessage:(NSString * _Nullable)message __attribute__((swift_name("init(message:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
...
@protocol SharedEnvironment
@required
@property id _Nullable currentToken __attribute__((swift_name("currentToken")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("FilesUseCase")))
@interface SharedFilesUseCase : SharedBase
- (void)setupFileIdFileId:(NSString *)fileId __attribute__((swift_name("setupFileId(fileId:)")));
- (void)subscribeOnChange:(void (^)(SharedDownloadableFile *))onChange __attribute__((swift_name("subscribe(onChange:)")));
@property (readonly) SharedAuthorizedFilesApi *filesApi __attribute__((swift_name("filesApi")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("RegisterUseCase")))
@interface SharedRegisterUseCase : SharedBase

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)registerNickName:(NSString *)nickName completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("register(nickName:completionHandler:)")));
@end
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (SharedFilesUseCase * _Nullable)createFilesUseCaseAndReturnError:(NSError * _Nullable * _Nullable)error __attribute__((swift_name("createFilesUseCase()")));
- (SharedRegisterUseCase *)createRegisterUseCase __attribute__((swift_name("createRegisterUseCase()")));
@end

__attribute__((unavailable("can't be imported")))
__attribute__((swift_name("ThrowableToNSErrorMapper")))
@interface SharedThrowableToNSErrorMapper : NSObject
@end

@interface SharedMeetacyApiCompanion (Extensions)
- (SharedMeetacyApi *)productionHttpClient:(SharedKtor_client_coreHttpClient *)httpClient enableLogging:(BOOL)enableLogging json:(SharedKotlinx_serialization_jsonJson *)json __attribute__((swift_name("production(httpClient:enableLogging:json:)")));
@end

@interface SharedAuthorizedFilesApi (Extensions)
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)downloadFileId:(id)fileId destination:(id<SharedKotlinSuspendFunction0>)destination onUpdate:(void (^)(SharedLong *, SharedLong *))onUpdate completionHandler_:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("download(fileId:destination:onUpdate:completionHandler_:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)uploadFile:(SharedUploadableFile *)file completionHandler:(void (^)(NSString * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("upload(file:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)uploadFileSize:(int64_t)fileSize source:(id<SharedKotlinSuspendFunction0>)source onUpdate:(void (^)(SharedLong *, SharedLong *))onUpdate completionHandler:(void (^)(NSString * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("upload(fileSize:source:onUpdate:completionHandler:)")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)downloadDestination:(id<SharedKotlinSuspendFunction0>)destination onUpdate:(void (^)(SharedLong *, SharedLong *))onUpdate completionHandler_:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("download(destination:onUpdate:completionHandler_:)")));
@end

@interface SharedFileRepository (Extensions)
...
@interface SharedFilesApi (Extensions)
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("FileRepositoryKt")))
@interface SharedFileRepositoryKt : SharedBase
+ (SharedFileRepository *)FileRepositoryId:(id)id api:(SharedAuthorizedMeetacyApi *)api __attribute__((swift_name("FileRepository(id:api:)")));
+ (SharedFileRepository * _Nullable)FileRepositoryId:(id _Nullable)id api_:(SharedAuthorizedMeetacyApi *)api __attribute__((swift_name("FileRepository(id:api_:)")));
+ (SharedFileRepository * _Nullable)FileRepositoryId:(id _Nullable)id api__:(SharedMeetacyApi *)api __attribute__((swift_name("FileRepository(id:api__:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ConstantsKt")))
@interface SharedConstantsKt : SharedBase
@property (class, readonly) int32_t DEFAULT_BUFFER_SIZE __attribute__((swift_name("DEFAULT_BUFFER_SIZE")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("IOChannelKt")))
@interface SharedIOChannelKt : SharedBase
+ (id<SharedIOChannel>)IOChannel __attribute__((swift_name("IOChannel()")));
@end
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
+ (void)readIterative:(id<SharedInput>)receiver buffer:(SharedByteArrayView *)buffer consume:(void (^)(SharedByteArrayView *))consume completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("readIterative(_:buffer:consume:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
+ (void)readIterative:(id<SharedInput>)receiver bufferSize:(int32_t)bufferSize consume:(void (^)(SharedByteArrayView *))consume completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("readIterative(_:bufferSize:consume:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
+ (void)transferTo:(id<SharedInput>)receiver output:(id<SharedOutput>)output bufferSize:(int32_t)bufferSize onUpdate:(void (^)(SharedLong *))onUpdate completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("transferTo(_:output:bufferSize:onUpdate:completionHandler:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("IOSourceKt")))
@interface SharedIOSourceKt : SharedBase

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
+ (void)use:(id<SharedIOSource>)receiver block:(id _Nullable (^)(id<SharedIOChannel>))block completionHandler:(void (^)(id _Nullable_result, NSError * _Nullable))completionHandler __attribute__((swift_name("use(_:block:completionHandler:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("InputSourceKt")))
@interface SharedInputSourceKt : SharedBase

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
+ (void)use:(id<SharedInputSource>)receiver block:(id<SharedKotlinSuspendFunction1>)block completionHandler:(void (^)(id _Nullable_result, NSError * _Nullable))completionHandler __attribute__((swift_name("use(_:block:completionHandler:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("OutputSourceKt")))
@interface SharedOutputSourceKt : SharedBase

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
+ (void)use:(id<SharedOutputSource>)receiver block:(id<SharedKotlinSuspendFunction1>)block completionHandler:(void (^)(id _Nullable_result, NSError * _Nullable))completionHandler __attribute__((swift_name("use(_:block:completionHandler:)")));
@end
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
+ (void)writeIterative:(id<SharedOutput>)receiver block:(SharedByteArrayView * _Nullable (^)(void))block completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("writeIterative(_:block:completionHandler:)")));
@end
...
__attribute__((swift_name("TypesUser")))
@protocol SharedTypesUser
@required
@property (readonly) id _Nullable avatarId __attribute__((swift_name("avatarId")));
@property (readonly) id id __attribute__((swift_name("id")));
@property (readonly) BOOL isSelf __attribute__((swift_name("isSelf")));
@property (readonly) NSString *nickname __attribute__((swift_name("nickname")));
@property (readonly) id<SharedTypesRelationship> _Nullable relationship __attribute__((swift_name("relationship")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("TypesSelfUser")))
@interface SharedTypesSelfUser : SharedBase <SharedTypesUser>
- (instancetype)initWithId:(id)id email:(id _Nullable)email nickname:(NSString *)nickname emailVerified:(BOOL)emailVerified avatarId:(id _Nullable)avatarId __attribute__((swift_name("init(id:email:nickname:emailVerified:avatarId:)"))) __attribute__((objc_designated_initializer));
- (SharedTypesSelfUser *)doCopyId:(id)id email:(id _Nullable)email nickname:(NSString *)nickname emailVerified:(BOOL)emailVerified avatarId:(id _Nullable)avatarId __attribute__((swift_name("doCopy(id:email:nickname:emailVerified:avatarId:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) id _Nullable avatarId __attribute__((swift_name("avatarId")));
...
__attribute__((swift_name("TypesConfirmEmailStatus")))
@protocol SharedTypesConfirmEmailStatus
@required
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("TypesRegularUser")))
@interface SharedTypesRegularUser : SharedBase <SharedTypesUser>
- (instancetype)initWithId:(id)id nickname:(NSString *)nickname avatarId:(id _Nullable)avatarId relationship:(id<SharedTypesRelationship>)relationship __attribute__((swift_name("init(id:nickname:avatarId:relationship:)"))) __attribute__((objc_designated_initializer));
- (SharedTypesRegularUser *)doCopyId:(id)id nickname:(NSString *)nickname avatarId:(id _Nullable)avatarId relationship:(id<SharedTypesRelationship>)relationship __attribute__((swift_name("doCopy(id:nickname:avatarId:relationship:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) id _Nullable avatarId __attribute__((swift_name("avatarId")));
...
@property (readonly) BOOL isSelf __attribute__((swift_name("isSelf")));
@property (readonly) NSString *nickname __attribute__((swift_name("nickname")));
@property (readonly) id<SharedTypesRelationship> relationship __attribute__((swift_name("relationship")));
@end

__attribute__((swift_name("TypesOptional")))
@protocol SharedTypesOptional
@required
@property (readonly) id _Nullable value __attribute__((swift_name("value")));
@end

__attribute__((swift_name("TypesRelationship")))
@protocol SharedTypesRelationship
@required
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("TypesMeeting")))
@interface SharedTypesMeeting : SharedBase
- (instancetype)initWithId:(id)id creator:(id<SharedTypesUser>)creator date:(id)date location:(SharedTypesLocation *)location title:(NSString *)title description:(NSString * _Nullable)description participantsCount:(int32_t)participantsCount previewParticipants:(NSArray<id<SharedTypesUser>> *)previewParticipants isParticipating:(BOOL)isParticipating avatarId:(id _Nullable)avatarId visibility:(SharedTypesMeetingVisibility *)visibility __attribute__((swift_name("init(id:creator:date:location:title:description:participantsCount:previewParticipants:isParticipating:avatarId:visibility:)"))) __attribute__((objc_designated_initializer));
- (SharedTypesMeeting *)doCopyId:(id)id creator:(id<SharedTypesUser>)creator date:(id)date location:(SharedTypesLocation *)location title:(NSString *)title description:(NSString * _Nullable)description participantsCount:(int32_t)participantsCount previewParticipants:(NSArray<id<SharedTypesUser>> *)previewParticipants isParticipating:(BOOL)isParticipating avatarId:(id _Nullable)avatarId visibility:(SharedTypesMeetingVisibility *)visibility __attribute__((swift_name("doCopy(id:creator:date:location:title:description:participantsCount:previewParticipants:isParticipating:avatarId:visibility:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) id _Nullable avatarId __attribute__((swift_name("avatarId")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("TypesLocation")))
@interface SharedTypesLocation : SharedBase
...
@property (class, readonly, getter=companion) SharedTypesLocationCompanion *companion __attribute__((swift_name("companion")));
- (SharedTypesLocation *)doCopyLatitude:(double)latitude longitude:(double)longitude __attribute__((swift_name("doCopy(latitude:longitude:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("TypesMeeting.Visibility")))
@interface SharedTypesMeetingVisibility : SharedKotlinEnum<SharedTypesMeetingVisibility *>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)initWithName:(NSString *)name ordinal:(int32_t)ordinal __attribute__((swift_name("init(name:ordinal:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
@property (class, readonly) SharedTypesMeetingVisibility *public_ __attribute__((swift_name("public_")));
@property (class, readonly) SharedTypesMeetingVisibility *private_ __attribute__((swift_name("private_")));
+ (SharedKotlinArray<SharedTypesMeetingVisibility *> *)values __attribute__((swift_name("values()")));
@end

__attribute__((swift_name("TypesPagingRepository")))
@protocol SharedTypesPagingRepository
@required
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)nextAmount:(int32_t)amount completionHandler:(void (^)(id<SharedTypesPagingRepository> _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("next(amount:completionHandler:)")));
@property (readonly) SharedTypesPagingResponse<id> *response __attribute__((swift_name("response")));
@end

__attribute__((swift_name("TypesPagingSource")))
@protocol SharedTypesPagingSource
@required
- (id<SharedTypesPagingIterator>)iterator __attribute__((swift_name("iterator()")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("TypesUserLocationSnapshot")))
@interface SharedTypesUserLocationSnapshot : SharedBase
- (instancetype)initWithUser:(SharedTypesRegularUser *)user locationSnapshot:(SharedTypesLocationSnapshot *)locationSnapshot __attribute__((swift_name("init(user:locationSnapshot:)"))) __attribute__((objc_designated_initializer));
- (instancetype)initWithUser:(SharedTypesRegularUser *)user location:(SharedTypesLocation *)location capturedAt:(id)capturedAt __attribute__((swift_name("init(user:location:capturedAt:)"))) __attribute__((objc_designated_initializer));
- (SharedTypesUserLocationSnapshot *)doCopyUser:(SharedTypesRegularUser *)user location:(SharedTypesLocation *)location capturedAt:(id)capturedAt __attribute__((swift_name("doCopy(user:location:capturedAt:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) id capturedAt __attribute__((swift_name("capturedAt")));
@property (readonly) SharedTypesLocation *location __attribute__((swift_name("location")));
@property (readonly) SharedTypesRegularUser *user __attribute__((swift_name("user")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("TypesPagingResponse")))
@interface SharedTypesPagingResponse<__covariant T> : SharedBase
- (instancetype)initWithData:(NSArray<id> *)data nextPagingId:(id _Nullable)nextPagingId __attribute__((swift_name("init(data:nextPagingId:)"))) __attribute__((objc_designated_initializer));
- (SharedTypesPagingResponse<T> *)doCopyData:(NSArray<id> *)data nextPagingId:(id _Nullable)nextPagingId __attribute__((swift_name("doCopy(data:nextPagingId:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (SharedTypesPagingResponse<id> *)mapTransform:(NSArray<id> *(^)(NSArray<id> *))transform __attribute__((swift_name("map(transform:)")));
- (SharedTypesPagingResponse<id> *)mapItemsTransform:(id _Nullable (^)(T _Nullable))transform __attribute__((swift_name("mapItems(transform:)")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSArray<id> *data __attribute__((swift_name("data")));
@property (readonly) id _Nullable nextPagingId __attribute__((swift_name("nextPagingId")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("TypesLocation.Companion")))
@interface SharedTypesLocationCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedTypesLocationCompanion *shared __attribute__((swift_name("shared")));
@property (readonly) SharedTypesLocation *NorthPole __attribute__((swift_name("NorthPole")));
@property (readonly) SharedTypesLocation *NullIsland __attribute__((swift_name("NullIsland")));
@end
...
__attribute__((swift_name("TypesPagingIterator")))
@protocol SharedTypesPagingIterator
@required
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)nextWithCompletionHandler:(void (^)(NSArray<id> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("next(completionHandler:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("TypesLocationSnapshot")))
@interface SharedTypesLocationSnapshot : SharedBase
- (instancetype)initWithLocation:(SharedTypesLocation *)location capturedAt:(id)capturedAt __attribute__((swift_name("init(location:capturedAt:)"))) __attribute__((objc_designated_initializer));
- (instancetype)initWithLatitude:(double)latitude longitude:(double)longitude capturedAt:(id)capturedAt __attribute__((swift_name("init(latitude:longitude:capturedAt:)"))) __attribute__((objc_designated_initializer));
- (SharedTypesLocationSnapshot *)doCopyLatitude:(double)latitude longitude:(double)longitude capturedAt:(id)capturedAt __attribute__((swift_name("doCopy(latitude:longitude:capturedAt:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) id capturedAt __attribute__((swift_name("capturedAt")));
